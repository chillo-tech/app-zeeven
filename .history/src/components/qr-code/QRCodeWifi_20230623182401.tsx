        ...
        <form noValidate className="block space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="block py-3 flex items-center">
            ...
            <div aria-labelledby="masque" className="grow inline-flex rounded-md shadow-sm" role="group">
              ...
              <button
                type="button"
                className="rounded-r-md border border-gray-200 bg-red-300 px-4 py-2 text-sm font-medium text-white hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 focus:ring-2 focus:ring-blue-700"
              >
                Messages
              </button>
            </div>
