...
function QRCodeVCARD({ type, handleMenu }: any) {
  ...
  const schema = yup
    .object({
      ...
      data: yup.object({
        civility: yup.string().trim().required('Ce champ civilité est requis'),
        firstName: yup.string().trim().required('Ce champ prénom est requis'),
        lastName: yup.string().trim().required('Ce champ est nom requis'),
        mobile: yup.string(),
        fax: yup.string(),
        phone: yup.string(),
        email: yup.string().trim().required('Ce champ email est requis'),
        company: yup.string(),
        job: yup.string(),
        street: yup.string(),
        city: yup.string(),
