      ...
      {mutation.isIdle ? (
        <form noValidate className="block space-y-6 py-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-2 block flex flex-col md:flex-row w-full ">
            ...
            <div className="grow flex flex-col md:flex-row w-full" aria-labelledby="numeros">
              <input
                type="text"
                id="phone"
                placeholder="Mobile"
              ...
              />
              <div className="mt-3 flex flex-col md:flex-row w-full gap-2 md:gap-0">
                <input
                  type="text"
                  id="phone"
                  placeholder="Fixe"
          ...
          <div className="mb-2 block flex flex-col md:flex-row w-full md:items-center">
            ...
            <div className="grow mt-3 flex flex-col md:flex-row w-full gap-2 md:gap-0" aria-labelledby="name">
