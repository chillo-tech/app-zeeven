...
function Hero() {
    ...
    <section className='bg-white'>
      ...
      <div className="container rounded-lg my-4 grid grid-cols-2 md:grid-cols-5 gap-4 bg-white">
        <article className="flex flex-col items-start md:py-24 py-10 md:grid-cols-3">
        ...
        <article className='relative px-6 md:grid-cols-2'>
