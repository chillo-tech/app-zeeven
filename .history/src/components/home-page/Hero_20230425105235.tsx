...
function Hero() {
	...
	return (
		<section className='md:h-screen xl:min-h-full relative'>
			<Head>
			...
			<section
				className={`text-center md:text-left flex flex-col items-center justify-center relative md:h-screen xl:min-h-full py-10 md:py-20 bg-gradient-to-r from-slate-100 to-slate-100 md:via-slate-100 font-light`}>
