...
function Statistics() {
  return (
    <section className={`container items-center mx-auto grid  justify-center md:grid-cols-${STATISTICS.length}`}>
      {STATISTICS.map((statistic, index) => (
        <article className='py-3 flex items-center' key={`statistic-${index}`}>
