...
function Hero() {
    ...
    <section className='bg-slate-50'>
      ...
      <div className="container rounded-lg my-4 grid grid-cols-2 gap-4 bg-slate-50">
        <article className="flex flex-col items-start py-10">
          ...
          <p className='flex gap-2 items-center justify-center'>
            <Link href="/create-campain" className='yellow-button' >Envoyez votre premier message
            </Link>
            <Link href="/contactez-nous" className={classNames('blue-link')}>
