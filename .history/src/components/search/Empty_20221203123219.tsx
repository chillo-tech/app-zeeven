  ...
  return (
    <article className='flex flex-col justify-center items-center py-8'>
      <div className="md:w-1/2 mx-auto text-center" >
        ...
        <h3 className="py-4 text-blue-900 font-semibold text-lg">
          {params.firstMessage}
        </h3>
        <div className="py-4 text-gray-600 text-lg">
          {params.secondMessage}
        </div>
        <button className={formStyles.form_control__button} type='button' onClick={params.button.action}>
          {params.button.label}
        </button>
      </div>
    </article>
