  ...
  return (
    <div className='search-result'>
        <div className="grid grid-cols-7">
          <span className='py-3 bg-slate-200'>Date</span>
          <span className='py-3 bg-slate-200'>Contacts</span>
          <span className='py-3 bg-slate-200'>Statut</span>
          <span className='py-3 bg-slate-200'/>
        </div>
        {data.map((item, index)=> (
          <>
