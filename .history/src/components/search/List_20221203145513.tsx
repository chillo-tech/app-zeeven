  ...
  return (
    <div className='search-result'>
        <div className="grid grid-cols-7">
          <span className='py-3 bg-slate-100 px-3'>Date</span>
          <span className='py-3 bg-slate-100 px-3'>Contacts</span>
          <span className='py-3 bg-slate-100 px-3'>Statut</span>
          <span className='py-3 bg-slate-100 px-3'/>
        </div>
        {data.map((item, index)=> (
          <>
