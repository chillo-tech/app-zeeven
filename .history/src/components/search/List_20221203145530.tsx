  ...
  return (
    <div className='search-result'>
        <div className="grid grid-cols-7">
          <span className='py-3 bg-slate-100 px-5 text-semibold'>Date</span>
          <span className='py-3 bg-slate-100 px-5 text-semibold'>Contacts</span>
          <span className='py-3 bg-slate-100 px-5 text-semibold'>Statut</span>
          <span className='py-3 bg-slate-100 px-5 text-semibold'/>
        </div>
        {data.map((item, index)=> (
          <>
