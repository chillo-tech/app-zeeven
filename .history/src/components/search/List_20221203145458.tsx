  ...
  return (
    <div className='search-result'>
        <div className="grid grid-cols-7">
          <span className='py-3 bg-slate-50'>Date</span>
          <span className='py-3 bg-slate-50'>Contacts</span>
          <span className='py-3 bg-slate-50'>Statut</span>
          <span className='py-3 bg-slate-50'/>
        </div>
        {data.map((item, index)=> (
          <>
