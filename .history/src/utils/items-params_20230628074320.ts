...
const TARIF_FIELDS =  `
      ...
      status,
      sublabel, 
      pages.prices.pricing_id.id,
      pages.prices.pricing_id.unit,
      pages.prices.pricing_id.reference,
      pages.prices.pricing_id.description,
      pages.prices.pricing_id.popular,
      pages.prices.pricing_id.label,
      pages.prices.pricing_id.sublabel,
      pages.prices.pricing_id.value,
      pages.prices.pricing_id.items.item_id.id,
      pages.prices.pricing_id.items.item_id.label
      ...
      pages.related_page_id.prices.pricing_id.reference,
