...
const PAGE_FIELDS =  `
      ...
      abstract,
      sublabel, 
      articles.related_page_id.id,
      articles.related_page_id.label,
      articles.related_page_id.sublabel,
      articles.related_page_id.prices.pricing_id.id,
      articles.related_page_id.prices.pricing_id.unit,
      articles.related_page_id.prices.pricing_id.frequence,
      articles.related_page_id.prices.pricing_id.description,
      articles.related_page_id.prices.pricing_id.popular,
      articles.related_page_id.prices.pricing_id.label,
      articles.related_page_id.prices.pricing_id.sublabel,
      articles.related_page_id.prices.pricing_id.type,
      articles.related_page_id.prices.pricing_id.value,
      articles.related_page_id.prices.pricing_id.channel,
      articles.related_page_id.prices.pricing_id.credits,
      articles.related_page_id.prices.pricing_id.items.item_id.id,
      articles.related_page_id.prices.pricing_id.items.item_id.label,
