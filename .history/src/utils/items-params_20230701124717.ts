...
const PAGE_FIELDS =  `
      ...
      articles.article_id.prices.pricing_id.id,
      articles.article_id.prices.pricing_id.unit,
      articles.article_id.prices.pricing_id.frequence,
      articles.article_id.prices.pricing_id.description,
      articles.article_id.prices.pricing_id.popular,
      articles.article_id.prices.pricing_id.label,
      articles.article_id.prices.pricing_id.sublabel,
      articles.article_id.prices.pricing_id.type,
      articles.article_id.prices.pricing_id.value,
      articles.article_id.prices.pricing_id.channel,
      articles.article_id.prices.pricing_id.credits,
      articles.article_id.prices.pricing_id.items.item_id.id,
      articles.article_id.prices.pricing_id.items.item_id.label,
