...
const PAGE_FIELDS =  `
      ...
      articles.article_id.articles.*,
      articles.related_article_id.id,
      articles.related_article_id.label,
      articles.related_article_id.sublabel,
      articles.related_article_id.abstract,
      articles.related_article_id.description,
