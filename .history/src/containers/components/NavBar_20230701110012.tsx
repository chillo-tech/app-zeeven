...
function NavBar() {
  ...
  return (
    <header className={` flex items-center justify-between bg-app-blue md:px-4 px-1 py-1 font-extralight`}>
      <div className="container mx-auto flex items-center justify-between">
                ...
                <li key={`meniu-${menu.id}`}>
                  <Link
                    href={`/${getUrl({
                      ...
                      url: slugify(`${menu.id}-${menu.label}`),
                      pattern: 'tarifs',
                    })}`}
        ...
        <button
          onClick={toggle}
          className="bg-app-blue text-app-brown flex items-center justify-center rounded-md font-semibold text-white md:hidden"
        >
