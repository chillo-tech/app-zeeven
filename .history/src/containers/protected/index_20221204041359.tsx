...
function ProtectedLayout({children}: {children: any}) {
  return (
    <section className={`bg-gradient-to-b from-blue-100 to-pink-50 min-h-screen font-light h-min-screen flex flex-col`}>
      <Header />
        ...
        <main className='lg:grid lg:grid-cols-12 lg:gap-x-5 my-10'>
          ...
          <section className='space-y-6 sm:px-6 lg:px-0 lg:col-span-12'>
            <section className='shadow sm:rounded-md sm:overflow-hidden min-h-fit'>
              <section className='bg-white py-6 px-4 sm:p-6 w-full prose min-h-400 max-w-full'>
                {children}
              </section>
            </section>
          </section>
