  ...
  return (
    <Layout>
      ...
      <section className='pt-10 pb-20 w-11/12 mx-auto md:w-1/2'>
        ...
        <article className="rounded-lg bg-white md:p-5 p-4 mt-3 border border-slate-200 shadow-sm">
        {mutation.isLoading ? (
        <Message 
          type="loading" 
        ...
        />) : null}
        {
          ...
          ? (
            <form noValidate className="block space-y-6" onSubmit={handleSubmit(onSubmit)}>
              <div className="block">
                <label htmlFor="name" className="w-full flex flex-col justify-between mb-2 text-md font-light">
                ...
                <input type="text" id="name" placeholder="Votre nom"
                    ...
                    {...register("name")}/>
                <p className="text-red-500">{errors.name?.applicationMessage}</p>
              </div>
              <div className="mb-0 text-md">
                <label htmlFor="phone" className="text-blue-800 w-full flex flex-col justify-between mb-2 text-md">Votre téléphone</label>
                <div className="mt-1 flex flex-col md:flex-row">
                  ...
                  <input placeholder="Votre téléphone"
                    type="number" autoComplete="false" className="border-gray-300 rounded-bl-lg rounded-br-lg  md:w-2/3 md:rounded-tr-lg md:rounded-br-lg md:rounded-bl-none shadow-sm focus:border-indigo-500 focus:ring-indigo-5000 py-2" {...register("phone")}
                  id="phone" />
                </div>
                <p className='text-red-600'>{errors?.phoneIndex?.applicationMessage}</p>
                <p className='text-red-600'>{errors?.phone?.applicationMessage}</p>
              </div>
              <div className="block">
              ...
              <div className="block">
                <label htmlFor="applicationMessage" className="w-full flex flex-col justify-between mb-2 text-md font-light">
                  <span className='text-blue-800'>
                    Votre applicationMessage
                  </span>
                </label>
                <textarea placeholder="Nous sommes à votre écoute, dites nous tout." id="applicationMessage"
                    className="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-5000 py-2"
                    {...register("applicationMessage")}></textarea>
                <p className="text-red-500">{errors.applicationMessage?.applicationMessage}</p>
              </div>

              <button type='submit' className='rounded-md bg-yellow-500 text-blue-900 border-yellow-500 px-4 py-2'>
                <span>Envoyer</span>
              </button>
            </form>
          ) : null
