                    ...
                    <>
                      <div
                        ...
                        className={classNames(
                          ...
                          'relative rounded-2xl rounded-xl bg-white py-8 px-16 shadow-lg',
                          'ring-white ring-opacity-60 ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2'
                        )}
                      >
                        <h1 className="text-font-extrabold flex flex-col text-black mb-10">
                        ...
                        <p className='flex justify-between text-lg mt-10'>
                          <span className='text-black opacity-70'>
                            Sous total
                          </span>
                          <span className='text-black opacity-70'>
                        ...
                        <p className='flex justify-between text-lg py-2 my-2 border-t border-b border-gray-200'>
                          <span className='text-black opacity-70'>
                            TVA (20%)
                          </span>
                          <span className='text-black opacity-70'>
                        ...
                        <p className='flex justify-between text-lg'>
                          ...
                          <span className='text-black opacity-70'>
                            {pricing_id?.value + tva(pricing_id?.value)} {pricing_id?.unit}
                          </span>
                        </p>
                      </div>
                    </>
