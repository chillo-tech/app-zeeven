...
function AcheterUneOffre({ option, product }: { option: string; product: string }) {
  ...
  return (
    <>
      ...
      <section className="grid grid h-screen grid-cols-2">
        ...
        <article className="flex flex-col p-3">
          ...
          {data ? (
            <div className="flex flex-col items-center justify-center border-b-2 border-blue-500">
              <h1 className="mb-8 mt-4 px-5 text-3xl font-extrabold text-black md:px-0 md:text-4xl">
                Notre offre de{' '}
