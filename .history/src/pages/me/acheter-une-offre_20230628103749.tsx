        ...
        <article className="flex flex-col p-3">
          ...
          {data ? (
            <div className="flex flex-col justify-center h-full">
              <div className='border border-red-300 md:w-2/3 mx-auto'>
                
              {data?.prices.map(({ pricing_id }: any) => (
                        <div
                ...
                <h1 className="px-5 text-font-extrabold text-black flex-col flex">
                  <span>{data.sublabel}</span>
                  <span className="uppercase text-app-blue">{}</span>
                </h1>
              </div>
