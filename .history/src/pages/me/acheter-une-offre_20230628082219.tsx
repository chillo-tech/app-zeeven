...
function AcheterUneOffre({ option, product }: { option: string; product: string }) {
  ...
  return (
    <>
      ...
      <section className="grid grid h-screen md:grid-cols-2">
        <div className="description flex flex-col justify-between bg-app-blue text-white">
          ...
          <div className="flex w-full items-center justify-between bg-white/20 px-6 py-2 text-white md:block hidden">
        ...
        <article className="flex flex-col p-3">
          ...
          {data ? (
            <div className="flex flex-col justify-center h-full">
              <h1 className="px-5 text-font-extrabold text-black md:px-0 md:text-4xl">
                Notre offre de{' '}
