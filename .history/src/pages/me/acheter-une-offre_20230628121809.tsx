...
function AcheterUneOffre({ option, product }: { option: string; product: string }) {
  ...
  const schema = yup
    .object({
      productId: yup.string().trim().required("le type n'est pas défini"),
      productName: yup.string().trim().required("le type n'est pas défini"),
      optionId: yup.string().trim().required("le type n'est pas défini"),
      optionName: yup.string().trim().required("le type n'est pas défini"),
      amountHT: yup.string().trim().required("le type n'est pas défini"),
