    ...
    <Metadata entry={{title: "Validez votre commande"}}/>
      <section className="grid grid h-screen grid-cols-2 border-4 border-red-400">
        <div className="description bg-app-blue pl-10 pt-6 text-white">
          ...
          La solution de Beaconstac nous a rendu la vie beaucoup plus facile. La création de codes QR est rapide et pouvoir suivre leurs performances s'est avéré essentiel pour notre entreprise.
          <span />
        </div>
      </section>
    </>
