...
function AcheterUneOffre() {
  const text = "La solution de Beaconstac nous a rendu la vie beaucoup plus facile. <br/> La création de codes QR est rapide et pouvoir suivre leurs performances s'est avéré essentiel pour notre entreprise."
  return (
    <>
