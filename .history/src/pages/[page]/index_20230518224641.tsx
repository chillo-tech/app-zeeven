              ...
              return (
               <section className={classNames( {'bg-white': index%2 ===0})} key={`page-${page_id.id}-${index}`} id={`#-${slugify(page_id.label)}`}>
                ...
                <div className="relative w-96 h-96">
                  <ImageDisplay
                    wrapperClasses = 'h-full relative rounded-lg border-8 border-app-blue overflow-hidden'
                    local={true}
                    image={{path: `/images/${page_id.label}-message.png`, title: 'Entammez vos échanges>avec ZEEVEN'}}/>
                </div>
                  <div>
                  <p className="flex">
