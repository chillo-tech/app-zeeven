            ...
            <Tab.Panels className="mt-8">
              {data?.pages.map(({ related_page_id }: any) => (
                <Tab.Panel key={`tarifs-values-${data.id}-${related_page_id.id}`}>
                  <h1 className="mt-4 mb-6 text-center text-5xl font-extrabold text-black">
                    Notre offre de <span className='text-yellow-600 uppercase'>{related_page_id.label}</span>
                  </h1>
