                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {related_page_id?.prices.map(({ pricing_id }: any) => (
                      ...
                      >
                        ...
                        <h2 className="mt-8 text-center text-3xl font-extrabold text-black">
                          {pricing_id?.value} {pricing_id?.unit}
                        </h2>
                        <p className="text-center text-xl text-gray-600 opacity-75">
                          {pricing_id?.description}
                        </p>
                        <p className="mt-8 text-center text-3xl font-extrabold text-black">
                          Inclus
                        </p>
                        <ul className='mt-10 text-md'>
