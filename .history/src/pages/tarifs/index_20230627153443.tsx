  ...
  return (
    <OpenedLayout>
      ...
      <section className='pt-16'>
        {data ? (
          <Tab.Group>
            <Tab.List className="flex space-x-1 rounded-xl bg-app-blue/20 p-1 container mx-auto md:w-11/12">
            ...
            <Tab.Panels className="mt-8">
              {data?.pages.map(({ related_page_id }: any) => (
                <Tab.Panel key={`tarifs-values-${data.id}-${related_page_id.id}`} className=" container mx-auto pb-10 pt-6 md:w-11/12">
