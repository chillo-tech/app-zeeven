            ...
            <Tab.Panels className="mt-8">
              {data?.pages.map(({ related_page_id }: any) => (
                <Tab.Panel key={`tarifs-values-${data.id}-${related_page_id.id}`}>
                  <h1 className="my-4 text-center text-6xl font-extrabold text-black">
                    Notre offre de <span className='text-sm font-normal uppercase'>{related_page_id.label}</span>
                  </h1>
