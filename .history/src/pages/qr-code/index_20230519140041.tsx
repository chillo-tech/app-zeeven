        ...
        {mutation.isIdle ? (
          <section className="container mx-auto mb-10 rounded-lg border-2 border-blue-300 bg-white md:w-2/3">
            <Message
              ...
              actionLabel="Retourner à l'accueil"
            />
            <Link href={'/'} className="flex items-center justify-between shadow-lg pr-6 py-1 text-black bg-white font-light rounded-md"
                            >
                <ImageDisplay
                  wrapperClasses = 'relative w-12 h-12 mr-4 ml-2 rounded-full overflow-hidden'
                  image={{path: 'https://api.zeeven.chillo.fr/qr-code/k0Tj69O6dO'}}/>
            </Link>
          </section>
        ) : null}
        {mutation.isSuccess ? (
