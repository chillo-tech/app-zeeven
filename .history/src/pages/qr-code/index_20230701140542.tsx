              ...
              {article_id.articles && article_id.articles.length ? (
                <section className="flex flex-col gap-4 py-4 md:flex-row">
                  {article_id.articles?.map(({ related_article_id }: any) => (
                    <div
                      className="rounded-lg relative justify-arround flex flex-col bg-app-light-blue border border-app-light-blue px-10 pb-20 pt-5 md:w-11/12"
                    ...
                    >
                      ...
                      <div className="absolute h-16 w-16 right-2 bottom-2">
                        <ImageDisplay
