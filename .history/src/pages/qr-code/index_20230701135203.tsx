          ...
          {data?.articles?.map(({ article_id }: any) => (
            ...
            >
              ...
              {article_id.articles && article_id.articles.length ? (
                <section className="flex flex-col md:flex-row gap-4 pt-3">
                  {article_id.articles?.map(({ related_article_id }: any) => (
                    <div
                      className="border border-app-light-blue bg-white px-10 pb-10 pt-5 md:w-11/12"
              ...
              <RenderHtmlContent content={article_id?.description} classes="py-10" />
