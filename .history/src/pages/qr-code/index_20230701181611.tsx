        ...
        <div className="container">
          ...
          {data?.articles?.map(({ article_id }: any, index: number) => (
            <div
              className={
                classNames(
                  "container mb-8 mx-auto rounded-xl border border-app-light-blue px-10  shadow-md md:w-11/12",
                  {"pt-5 pb-5": index === 0},
                  {"pb-8 pt-5": index !== 0},
          ...
          <RenderHtmlContent content={article_id?.abstract} classes="text-center py-10" />
              {article_id.articles && article_id.articles.length ? (
                <section className="flex flex-col gap-4 py-4 md:flex-row">
                  {article_id.articles?.map(({ related_article_id }: any) => (
                    <div
                      className="rounded-lg relative justify-between items-start flex flex-col bg-app-light-blue border border-app-light-blue px-10 pb-10 pt-5 md:w-11/12"
