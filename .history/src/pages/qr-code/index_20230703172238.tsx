      ...
      <section className="mx-auto mb-10 bg-app-light-gray pb-10">
        <div className="container">
          ...
          {data?.articles?.map(({ article_id }: any, index: number) => (
            <article
              className={classNames(
                'items-center mx-auto mb-8 rounded-xl border border-app-light-blue md:px-10  shadow-md md:w-11/12',
                { 'pb-5 pt-5': index === 0 },
                { 'pb-8 pt-5 grid grid-cols-3 gap-10': index !== 0 },
            ...
            >
              ...
              {article_id.articles && article_id.articles.length ? (
               ...
               <ImageDisplay
                          wrapperClasses="h-80 relative overflow-hidden rounded-full"
                          imageClasses="object-contain"
