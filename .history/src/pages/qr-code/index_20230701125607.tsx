...
function QRCode() {
  ...
  return (
    <OpenedLayout>
      ...
      <section className="mx-auto mb-10 md:p-0 bg-app-gray">
        <div className="container">
        <RenderHtmlContent content={data?.abstract} classes="text-center py-10" />
        {data?.articles?.map(({ article_id }: any) => (
          <div className="container mx-auto md:w-11/12" key={`article-${data.id}-${article_id.id}`}>
            <h1 className="mb-8 mt-4 px-5 text-center text-xl font-extrabold text-black md:px-0 md:text-4xl">
