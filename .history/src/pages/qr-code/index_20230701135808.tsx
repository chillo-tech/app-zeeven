              ...
              {article_id.articles && article_id.articles.length ? (
                <section className="flex flex-col gap-4 py-4 md:flex-row">
                  {article_id.articles?.map(({ related_article_id }: any) => (
                    <div
                      className="justify-arround flex flex-col border border-app-light-blue bg-white px-10 pb-10 pt-5 md:w-11/12"
                    ...
                    >
                      ...
                      <div className="relative h-96 w-96">
                        <ImageDisplay
                          ...
                          local={true}
                          image={{
                            path: `/images/${slugify(related_article_id.images[0].directus_files_id.id)}`,
