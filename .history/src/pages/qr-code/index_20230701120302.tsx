...
import { QR_CODES_TYPES, TARIF_FIELDS, slugify } from '@/utils';
    ...
    <OpenedLayout>
      ...
      <div className="container py-10 text-center font-sans">
        ...
        <h3 className="text-slate-900 sm:text-xl">
          Ciblez votre audience avec des codes QR portant votre marque.
          <br />
          N&acute;imprimez pas en vain - vous pourrez changer la destination à tout moment.
        </h3>
      </div>
