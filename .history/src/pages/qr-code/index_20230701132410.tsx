      ...
      <section className="bg-app-light-gray mx-auto mb-10 md:p-0">
        <div className="container">
          ...
          {data?.articles?.map(({ article_id }: any) => (
            <div
              className="container mx-auto md:w-11/12 bg-white px-10 py-10 rounded-xl border border-app-light-blue shadow-sm"
              key={`article-${data.id}-${article_id.id}`}
            >
              <h3 className="mb-8 mt-4 px-5 text-lg font-extrabold text-black md:px-0 md:text-4xl">
