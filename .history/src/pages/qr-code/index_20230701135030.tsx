      ...
      <section className="bg-app-light-gray mx-auto mb-10 md:p-0">
        <div className="container">
          ...
          {data?.articles?.map(({ article_id }: any) => (
            <div
              className="container mx-auto md:w-11/12 bg-white px-10 pb-10 pt-5 rounded-xl border border-app-light-blue shadow-md"
            ...
            >
              ...
              <p>{article_id.sublabel}</p>
              {
                ...
                >
                  ...
                  <RenderHtmlContent content={related_article_id?.description} classes="py-10" />
