              ...
              {article_id.articles && article_id.articles.length ? (
                <section className="flex flex-col gap-4 py-4 md:flex-row">
                  {article_id.articles?.map(({ related_article_id }: any) => (
                    <div
                      className="rounded-lg relative justify-between flex flex-col bg-app-light-blue border border-app-light-blue px-10 pb-10 pt-5 md:w-11/12"
                    ...
                    >
                      ...
                      <RenderHtmlContent content={related_article_id?.description} classes="mb-4"/>
                      </div>
                      <Link className="outline-blue-button" href="/contactez-nous">
                        Contactez nous
                      </Link>
                      <OutlineLink label="Génrer un QR CODE"/>
