    ...
    <Layout>
      ...
      <section className="mx-auto w-11/12 pb-20 pt-10 md:w-1/2">
        ...
        <h3 className="text-center text-lg text-app-blue">
          Nous vous prions de nous honorer de votre présence à notre mariage qui se déroulera du 09
          Août au 13 Août 2023 à Yaoundé! 
          <br />
            ...
            <form noValidate className="block space-y-6" onSubmit={handleSubmit(onSubmit)}>
              <div className="block">
                ...
                >
                  ...
                  <option value="M&Mme">Monsieur et Madame</option>
                </select>
              </div>
              ...
              <div className="block">
                <label className="text-md mb-2 flex w-full flex-col justify-between font-light">
