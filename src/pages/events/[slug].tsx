    ...
    <Layout>
      ...
      <section
        className={classNames(
          'mx-auto mt-10 grid w-11/12 rounded-md border border-slate-200 p-4 shadow-sm md:w-1/2 md:grid-cols-7'
        )}
      ...
      <section className="mx-auto flex w-11/12 flex-col pb-20 pt-10 md:w-1/2"></section>
    </Layout>
  );
}
