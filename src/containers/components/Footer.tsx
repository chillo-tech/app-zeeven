  ...
  return (
    <footer className='bg-blue-900 text-white text-2xl text-center md:text-left md:text-lg'>
      <div className="container mx-auto py-10 grid md:grid-cols-4 gap-6">
          <div className="logo">
            <Link href="/" className={`${oswald.className} text-white text-4xl py-3 !font-extrabold`}>ZEEVEN</Link>
      ...
      <div className="container mx-auto text-center py-5 !font-extralight border-t border-slate-400 text-sm">
