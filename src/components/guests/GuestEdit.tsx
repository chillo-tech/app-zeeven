		...
		<form onSubmit={handleFormSubmit(onSubmit)}>
			<div className="grid md:grid-cols-3 gap-4 my-4">
				<div className="mb-0 text-md">
					...
					<div className="mt-1">
						<select
							className="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-5000 py-2" {...register("civility")}
							id="civility">
				...
				<div className="mb-0 text-md">
					<label htmlFor="firstName"
						   className="w-full flex flex-col justify-between mb-2 text-md">Prénom</label>
					<div className="mt-1">
						<input autoComplete="false"
							   className="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-5000 py-2" {...register("firstName")}
				...
				<div className="mb-0 text-md">
					...
					<div className="mt-1">
						<input autoComplete="false"
							   className="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-5000 py-2" {...register("lastName")}
				...
				<div className="mb-0 text-md">
					<label htmlFor="phone"
						   className="w-full flex flex-col justify-between mb-2 text-md">Téléphone</label>
					<div className="mt-1 flex flex-col md:flex-row">
						<select {...register("phoneIndex")}
								className="border-gray-300 rounded-tl-lg rounded-tr-lg w-full md:w-1/3 md:rounded-tr-none md:rounded-bl-lg shadow-sm">
				...
				<div className="mb-0 text-md">
					...
					<div className="mt-1">
						<input autoComplete="false"
							   className="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-5000 py-2" {...register("email")}
							   type="email" id="email"/>
					</div>
