...
function Dates() {
  ...
  const {date , time = '00:00'} = (campain && campain.messages && campain.messages.length) ?  campain.messages[0]: {date: ''};
	...
	return (
      ...
      <h2 className="mb-2 w-full flex flex-col justify-between mb-2 text-lg lg:text-xl font-light">
          <span className='text-app-blue font-semibold'>Quand voulez vous envoyer message</span>
