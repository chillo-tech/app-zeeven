...
function Statistics() {
  return (
    <section className={`container mx-auto grid gap-4 md:grid-cols-${STATISTICS.length}`}>
      {STATISTICS.map((statistic, index) => (
        <article className='py-5 mx-10 md:mx-0 flex items-center' key={`statistic-${index}`}>
