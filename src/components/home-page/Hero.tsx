...
function Hero() {
  ...
  return (
    <section className='h-screen xl:min-h-full relative'>
      <Head>
      ...
      <section className={`text-center md:text-left flex flex-col items-center justify-center relative h-screen xl:min-h-full py-10 md:py-20 bg-gradient-to-r from-slate-100 to-slate-100 md:via-slate-100 font-light`}>
        <div className="container mx-auto grid md:grid-cols-2 items-center">
          <div className="flex flex-col items-start px-3 md:py-30">
            ...
            <Link href="/create-campain" className={`mx-auto md:mx-0 bg-yellow-400 text-blue-900 border-yellow-500 text-lg py-2 rounded-lg px-5`}>
